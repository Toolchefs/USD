...
def RunCMake(context, force, extraArgs = None):
    ...
    with CurrentWorkingDirectory(buildDir):
        Run('cmake '
            ...
            '-DCMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION=10.0.10586.0 '
...
if Windows():
    ...
    TBB_URL = "https://github.com/oneapi-src/oneTBB/archive/2020_U3.tar.gz"
else:
    TBB_URL = "https://github.com/oneapi-src/oneTBB/archive/2020_U3.tar.gz"
...
OPENEXR_URL = "https://github.com/AcademySoftwareFoundation/openexr/archive/v3.2.1.zip"
...
PTEX_URL = "https://github.com/wdas/ptex/archive/v2.4.1.zip"
